# ClownSampler_Beta_Standalone ComfyUI Custom Nodes

A minimal standalone package that gives you
**ClownSampler_ Beta**, **ClownSampler_Advanced_Beta**, **ClownOptions_SDE_Beta** and **SharkOptions_Beta** custom nodes in ComfyUI, without installing the entire
...
└─ custom_nodes/
   └─ ClownSampler_Beta_Standalone/
      ...
      └─ beta/
         ...
         └─ samplers_extensions.py     ← copy from RES4LYF  beta/samplers_extensions.py   ← copy from RES4LYF
      └─ lightricks/
         ├─ model.py                   ← copy from RES4LYF  lightricks/model.py
         └─ symmetric_patchifier.py    ← copy from RES4LYF  lightricks/symmetric_patchifier.py ← copy from RES4LYF
```
